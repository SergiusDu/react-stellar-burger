  ...
  return (
    <>
      <header className={`mt-30 ${styles.order_header}`}>
        ...
        <p className={`mt-8 text text_type_main-default`}>идентификатор
                                                          заказа</p >
      </header >
      <figure className={styles.order_figure}>
        ...
        />
        <figcaption >
          <p className={`text text_type_main-small mt-15`}>Ваш заказ начали
                                                           готовить</p >
        </figcaption >
      </figure >
      <footer >
        <p className={`mt-2 mb-30 text text_type_main-small text_color_inactive`}>Дождитесь
                                                                                  готовности
                                                                                  на
                                                                                  орбитальной
                                                                                  станции</p >
