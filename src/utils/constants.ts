...
export const GET_ORDERS_WS_ENDPOINT = `wss://norma.nomoreparties.space/orders`;
export const CONNECT_PROFILE_WEBSOCKET = 'profileSlice/WEBSOCKET_CONNECT';
export const DISCONNECT_PROFILE_WEBSOCKET: 'profileSlice/WEBSOCKET_DISCONNECT' = 'profileSlice/WEBSOCKET_DISCONNECT';
export const CONNECT_FEED_WEBSOCKET: 'feedSlice/WEBSOCKET_CONNECT' = 'feedSlice/WEBSOCKET_CONNECT';
export const DISCONNECT_FEED_WEBSOCKET: 'feedSlice/WEBSOCKET_DISCONNECT' = 'feedSlice/WEBSOCKET_DISCONNECT';
export  const GET_ALL_ORDERS_WS_ENDPOINT: `wss://norma.nomoreparties.space/orders/all` = `wss://norma.nomoreparties.space/orders/all`;
