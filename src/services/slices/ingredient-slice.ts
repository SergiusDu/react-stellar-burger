...
export const fetchIngredients = createAsyncThunk(
  'ingredient/fetchIngredients', async (
    _,
    {rejectWithValue},
  ) => {
    try {
      const response: IngredientType[] = await fetchAPI(
...
export const ingredientSliceInitialState: IngredientState = {
...
export const ingredientSlice = createSlice({
  name: 'ingredient', initialState: ingredientSliceInitialState, reducers: {
